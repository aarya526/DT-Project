...
<div>
<center>  
<h4>Please Add Shipping And Billing Address</h4>
<h5></h5>
<hr />  
</div>
</center>
    		...
    		<div class="row">
    			<div class="col-xs-6">
        			<table style="margin-bottom:20px;">
        			 ...
        			 <tr>
        			 <td><a class ="btn btn-danger" href = "${flowExecutionUrl }&_eventId=page1">Back To Cart</a></td>
        			 <td style="float:right;"><a class ="btn btn-success" href = "${flowExecutionUrl }&_eventId=page3">Order Review</a></td>
        			 </tr>
        			</table>
