...
<div class="dropdown1">
    <button class="dropbtn1 " ><b>Playstation</b></button>
...
<c:choose>
	...
	<div class="btn-group">
<a class="btn btn-success"  style="color:white" href="gallery"><b>All Products</b></a>
<a   class="btn btn-success" href="login"><b>${pageContext.request.userPrincipal.name}</b></a>
<button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
<span class="caret"></span> 
</button>
<div class="dropdown-menu" >
<a class="dropdown-item" href="${pageContext.request.contextPath }/beginCart">My Cart</a>
