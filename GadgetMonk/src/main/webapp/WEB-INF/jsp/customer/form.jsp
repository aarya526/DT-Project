...
<div class="dropdown1">
    ...
    <div class="dropdown-content1">
      ...
      <img class="ps4" src="${pageContext.request.contextPath }/resources/images/dropdown images/ps4.png"></img>
      <img class="ps4pro" src="${pageContext.request.contextPath }/resources/images/dropdown images/ps4pro.png"></img>
      <img class="buy" src="${pageContext.request.contextPath }/resources/images/dropdown images/buy.png"></img>
    ...
    <div class="dropdown-content1">
      <div class="header1" style="height:250px;">
      <img class="psvr" src="${pageContext.request.contextPath }/resources/images/Playstation images/psvr.png"></img>
      <img class="buy" src="${pageContext.request.contextPath }/resources/images/dropdown images/buy.png"></img>
	  </div>
      </div>
    </div>
...
<div class="form-group">
<label for="address:" style="float:left;margin-bottom:0px;">Address:</label>
<form:input style="margin-bottom:10px;" type="text" class="form-control" placeholder="Enter Address:" path="address"/>
