            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <c:forEach items="${list}"  var="product">
                        <tr>
                            <td><img class="img" style="width:200px;" src="${pageContext.request.contextPath }/resources/${product.imageUrl }" /> </td>
                            <td>${product.productname }</td>
                            <td>${product.company }</td>
                            <td>In stock(<font style="color:red;">Quantity left:${product.quantity }</font>)</td>
                            <td><input class="form-control" type="text" value="1" /></td>
                            <td class="text-right">Rs. ${product.price } </td>
                            <td class="text-right"> <button type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Remove </button> </td>
                        </tr>
                        </c:forEach>
                        <tr>
                            <td></td>
        ...
        <div class="col mb-2">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 text-right">
                    <a href ="${flowExecutionUrl}&_eventId=GoToCheckout" class="btn btn-lg btn-block btn-success text-uppercase">Checkout</a>
                </div>
            </div>
        </div>
    </div>
